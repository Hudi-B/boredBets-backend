...
CREATE TABLE `bet_types` (
  `Id` int NOT NULL,
  `bet_type` varchar(20) COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
INSERT INTO `bet_types` VALUES (0,'FiveInOrder'),(1,'FiveWithOut');
...
-- Dump completed on 2024-04-30 20:31:56
